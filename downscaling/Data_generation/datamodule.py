...
from Data_generation.dataset_STAttn import (
    Forecast,
...
class GlobalForecastDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            self.data_train = myIndividualForecastDataIter(
                    myForecast(
                        myNpyReader(
            ...
            self.data_val = myIndividualForecastDataIter(
                myForecast(
                    myNpyReader(
            ...
            self.data_test = myIndividualForecastDataIter(
                myForecast(
                   myNpyReader(
